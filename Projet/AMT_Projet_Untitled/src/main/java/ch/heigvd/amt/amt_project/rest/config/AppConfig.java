...
public class AppConfig extends Application {
  ...
  private void addRestResourceClasses(Set<Class<?>> resources) {
    resources.add(ch.heigvd.amt.amt_project.rest.config.MyExceptionMapper.class);
    resources.add(ch.heigvd.amt.amt_project.rest.config.MyObjectMapperProvider.class);
  }
